...
# /home/minghao.zhou/miniconda3/lib/python3.11/site-packages/diffusers/pipelines/stable_diffusion_xl/pipeline_stable_diffusion_xl_img2img.py

def freezeModels(pipeline):
    assert type(pipeline) == StableDiffusionXLImg2ImgPipeline
...
def get_tensor_outputs(
    ...
    **kwargs,
    ...
    if not output_type == "latent":
        ...
        # print("latent", latents, latents.shape)
